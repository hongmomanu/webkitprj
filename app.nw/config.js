...
if(!localStorage.recordurl)localStorage.recordurl="http://10.33.5.103:8080/JOPENSWeb/mon/logStationFormController?key=3";
if(!localStorage.recordurlfilter)localStorage.recordurlfilter="http://10.33.253.103:8080/JOPENSWeb/mon/logStationFormController?key=3";
if(!localStorage.recordstation)localStorage.recordstation='["XAJ"]';
